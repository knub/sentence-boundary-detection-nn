...
print ("use 'main_no_loading(net, vector)' to interactively explore the demo")
print ("use 'main_no_loading(net, vector, \"path/to/file\")' to analyze the contents of 'path/to/file'")
